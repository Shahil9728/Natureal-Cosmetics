...
const lenis = new Lenis({
    duration: 1.2,
    easing: (t)=>Math.min(1.001 - Math.pow(2, -10 * t))
});
function raf(time) {
    lenis.raf(time);
...
(0, _gsapDefault.default).to(".homeimg", {
    rotateX: "0deg",
    duration: 3,
    scrollTrigger: {
        trigger: ".homeimg",
...
(0, _gsapDefault.default).to(".codeimg", {
    y: 450,
    duration: 30,
    scrollTrigger: {
        trigger: ".codeimg",
...
(0, _gsapDefault.default).fromTo(".codehead", {
    y: 200,
    opacity: 0
}, {
    y: 0,
...
(0, _gsapDefault.default).to(".codeheader", {
    opacity: 0,
    duration: 3,
    scrollTrigger: {
        trigger: ".resphead",
...
(0, _gsapDefault.default).to(".codesubhead", {
    opacity: 0,
    duration: 3,
    scrollTrigger: {
        trigger: ".resphead",
...
(0, _gsapDefault.default).to(".respimg", {
    opacity: 0,
    y: -1000,
    duration: 1,
    scrollTrigger: {
...
(0, _gsapDefault.default).fromTo(".resphead", {
    opacity: 0,
    ease: "power2.out",
    duration: 2
}, {
...
(0, _gsapDefault.default).to(".resphead", {
    opacity: 0,
    duration: 1,
    scrollTrigger: {
        trigger: ".respimg3",
...
(0, _gsapDefault.default).to(".respimg1", {
    opacity: 0,
    y: -1000,
    duration: 1,
    scrollTrigger: {
...
let currentIndex = 1;
(0, _gsapDefault.default).to(".respimg2", {
    scale: 0.7,
    opacity: 0,
    scrollTrigger: {
        trigger: ".respimg3",
...
function showImage(index) {
    (0, _gsapDefault.default).to(images[currentIndex], {
        opacity: 0,
        zIndex: 3,
        y: -50,
        duration: 1
    });
    (0, _gsapDefault.default).to(images[index], {
        opacity: 1,
        zIndex: 6 + index,
        duration: 1,
        y: 0
...
(0, _gsapDefault.default).to(".respimg3", {
    scale: 1.5,
    duration: 1,
    scrollTrigger: {
...
const maskTimeline = (0, _gsapDefault.default).timeline({
    paused: true,
    delay: 5,
    scrollTrigger: {
        trigger: ".resp6scale",
...
(0, _gsapDefault.default).to({}, {
    ...
    scrollTrigger: {
        ...
        onUpdate: (self)=>{
            ...
            const respimg5Opacity = (0, _gsapDefault.default).getProperty(".respimg5", "opacity");
            if (indexToShow === images.length - 1 && respimg5Opacity === 1) maskTimeline.play();
        }
    }
});
const yvalue = isMobile ? "40" : "100";
maskTimeline.fromTo(".mask", {
    opacity: 0
}, {
    opacity: 1,
    duration: 2,
    ...
    height: isMobile ? "220px" : "410px",
    width: isMobile ? "250px" : "475px",
    duration: 5,
    ease: "power2.out"
}).fromTo(".respfoot", {
    opacity: 0
...
images1.forEach((image, index)=>{
    let scrubValue;
    if (index === 0) scrubValue = 0.5;
    else if (index === 1) scrubValue = 3;
    else if (index === 2) scrubValue = 2.0;
    else if (index === 3) scrubValue = 0.8;
    else if (index === 4) scrubValue = 0.5;
    else scrubValue = 1.0;
...
(0, _gsapDefault.default).fromTo(".footerhead", {
    opacity: 0
}, {
    opacity: 1,
    duration: 1,
...
// Retouching page
(0, _gsapDefault.default).to(".hero1", {
    opacity: 0,
    duration: 1,
    ease: "power2.out",
    scrollTrigger: {
...
(0, _gsapDefault.default).fromTo(".hero2", {
    opacity: 0,
...
(0, _gsapDefault.default).to(".hero2", {
    opacity: 0,
    duration: 2,
    ease: "power2.out",
    scrollTrigger: {
...
(0, _gsapDefault.default).fromTo(".hero3", {
    opacity: 0,
    y: 100
}, {
    opacity: 1,
...
(0, _gsapDefault.default).to(".hero3", {
    opacity: 0,
    duration: 2,
    ease: "power2.out",
    scrollTrigger: {
...
(0, _gsapDefault.default).to(".rsubheading1", {
    opacity: 0,
    duration: 1,
    ease: "power2.out",
    scrollTrigger: {
...
(0, _gsapDefault.default).fromTo(".rsubheading2", {
    opacity: 0,
...
(0, _gsapDefault.default).to(".rheadingsection", {
    opacity: 0,
    duration: 1,
    ease: "power2.out",
    scrollTrigger: {
...
(0, _gsapDefault.default).to(".rmask", {
    opacity: 1,
    ease: "power2.out",
    scrollTrigger: {
        trigger: ".hero4",
...
(0, _gsapDefault.default).to(".hero4", {
    scaleY: 3.15,
    scaleX: 2.1,
    ease: "power2.out",
    scrollTrigger: {
...
(0, _gsapDefault.default).fromTo(".carheader", {
    y: 100,
    opacity: 0
}, {
    y: 0,
...
(0, _gsapDefault.default).fromTo(".rcomi", {
    width: "100%"
}, {
...
(0, _gsapDefault.default).fromTo(".rcompheader", {
    opacity: 0,
    y: 100
}, {
    opacity: 1,
...
(0, _gsapDefault.default).to(".rcompheader", {
    opacity: 0,
    ease: "power2.out",
    y: -100,
    scrollTrigger: {
...
(0, _gsapDefault.default).fromTo(".rcomimgs", {
    y: 100,
    opacity: 0
}, {
    y: 0,
...
const imageshifting = (0, _gsapDefault.default).timeline({
    delay: 5,
    scrollTrigger: {
        trigger: ".rcomimgs",
        start: "top 50%",
...
imageshifting.to(".rimg2i", {
    ...
    x: isMobile ? "150%" : "230%",
    y: isgrtlaptop ? "-110%" : istab ? "0%" : isMobile ? "60%" : "-20%",
    duration: 1,
    ease: "power2.out"
}).to(".rimg3i", {
    x: isgrtlaptop ? "-260%" : istab ? "-72%" : isMobile ? "-106%" : "-150%",
    y: isMobile ? "100%" : "",
    width: isMobile ? "120%" : "",
    duration: 1,
    ease: "power2.out"
});
(0, _gsapDefault.default).to(".rimg3i", {
    y: isgrtlaptop ? "270%" : isMobile ? 850 : 700,
    ease: "power2.out",
    scrollTrigger: {
        trigger: ".rproj1",
        start: "top 50%",
...
(0, _gsapDefault.default).to(".rimg2ii", {
    y: istab ? 710 : isMobile ? 800 : 630,
    ease: "power2.out",
    scrollTrigger: {
        trigger: ".rproj1",
        start: "top 50%",
...
(0, _gsapDefault.default).fromTo(".rimg1i", {
    y: 0
}, {
    y: 700,
    ease: "power2.out",
...
images2.forEach((image, index)=>{
    ...
    else if (index === 5) scrubValue = 3.5;
    else scrubValue = 1.0;
    (0, _gsapDefault.default).to(image, {
        y: -200,
        duration: 1,
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fTqHN","5AKj5"], "5AKj5", "parcelRequirefd8f")
